...
('Tarte a la vanille', 5000, 150);
('Cookies', , 200),
('Muffin aux fruits', , 120),
('Brownie', , 80);
('Gateau au chocolat', 250000, 100);
...
VALUES
    ...
    insert into vendeur(NomVendeur,PrenomVendeur,idGenre) values('Rasoerina','Luc',1);
    insert into vendeur(NomVendeur,PrenomVendeur,idGenre) values('Rasolofo','Marc',1);
    insert into vendeur(NomVendeur,PrenomVendeur,idGenre) values('Rabearimanana','Jean',2);

    insert into client(NomClient,PrenomClient) values('ROSALIE','MSSP');
    insert into client(NomClient,PrenomClient) values('RASTA','MAN');
    insert into client(NomClient,PrenomClient) values('GASI','KARA');
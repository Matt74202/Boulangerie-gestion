               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class="container mt-5">
                        <h2 class="text-center mb-4">Produit Conseil</h2>
                        <form action="./InsertConseilController" method="POST" class="p-4 border rounded shadow-sm">
                            <div class="mb-3">
                ...
                <%    }
                    %>
                            ...
                            <div class="mb-3">
                                <label for="mois" class="form-label">Date</label>

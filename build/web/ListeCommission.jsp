               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class="container mt-5">
                        <h2 class="text-center mb-4">Liste Commission</h2>
                
                        <!-- Formulaire de recherche -->
                        <form action="./ListeComission" method="GET" class="p-4 border rounded shadow-sm">
                            <div class="row g-3 mb-3">
                                <div class="mb-3">
                                    <label for="produit" class="form-label">Vendeur</label>
                                    <select id="produit" name="vendeur" class="form-select">
                                    <option value="0">Vendeur</option>
                                            <% for (Vendeur ta : vendeurs) { %>
